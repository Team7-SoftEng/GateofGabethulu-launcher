...
namespace LauncherPrototype
{
    ...
    public class Player
    {
        ...
        public Player(int kills, int deaths, String time, int att, int def, int spd, int life, int xp, char sex, String lastServer, Item savedItem1, Item savedItem2, Item savedItem3, Item savedItem4, Item savedItem5)
        {
        ...
        public void setTotalPlayTime(String time)
        {
